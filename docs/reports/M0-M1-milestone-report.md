...
### 真实数据实测 / Real-data evidence — 刻叶紫堇 *Corydalis ophiocarpa* SRR38978846
...
---
*本报告锚定 OpenSpec 归档 changes 与 `~/corydalis_validation/` 实测数据。任何数字与判定可在上述归档 change 的 VALIDATION 文档中复核。*
